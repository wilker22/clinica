<footer class="footer">
    <div class="w-100 clearfix">
        <span class="text-center text-sm-left d-md-inline-block"><b>Clínica v1.0</b> - Todos os Direitos Reservaods</span>
        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Desenvolvido <i class="fa fa-laptop text-danger"></i> por <a href="http://wtech.com.br/" class="text-dark" target="_blank">WTech - Consultoria em TI</a></span>
    </div>
</footer>
